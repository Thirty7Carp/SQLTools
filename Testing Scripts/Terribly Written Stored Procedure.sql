...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Insert CTE results into first temp table
        SELECT 
            ProductID,
            ProductName,
            ProductNumber,
        ...
        -- First UPDATE: Using table alias with windowing in subquery
        UPDATE fst
        SET 
            [Discount Applied] = 1,
        ...
        -- DELETE: Remove low revenue records
        ...
        -- Rollback to ensure no data is changed
